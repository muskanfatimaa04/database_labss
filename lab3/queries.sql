-- Lab 3: Aggregations & Analytics Queries
-- Author: Muskan
-- Date: April 2026

-- ============================================================
-- Query 1: Overall business summary (delivered orders only)
-- ============================================================
...
-- ============================================================
-- Query 6: Ranking orders per customer with ROW_NUMBER
-- ============================================================
SELECT customer_id,
       order_id,
       order_date,
...
-- ============================================================
-- Query 7: Global revenue ranking with RANK vs DENSE_RANK
-- ============================================================
SELECT order_id,
       customer_id,
       total_amount,
